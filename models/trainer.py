...
from eval_tool.metric_tool import ConfuseMatrixMeter
from models.losses import cross_entropy
import models.losses as losses

from eval_tool.logger_tool import Logger, Timer
...
class CDTrainer():
    ...
    def __init__(self, args, pretrained_model, dataloaders):

        self.dataloaders = dataloaders

        self.n_class = args.num_labels
        # define G
        ...
        self.vis_dir = args.output_dir+'/vis/'
