...
def validate_network(val_loader, model, linear_classifier, n, avgpool):
    ...
    # precision_func = Precision(num_classes=10, threshold=0.5,average='macro').cuda()
    # recall_func = Recall(num_classes=10, threshold=0.5,average='macro').cuda()
    # f1_func = F1Score(num_classes=10, threshold=0.5,average='macro').cuda()
    ...
    #     print('* Acc@1 {top1.global_avg:.3f} f1 {f1.global_avg:.3f} prec {prec.global_avg:.3f} rec {rec.global_avg:.3f} loss {losses.global_avg:.3f}'
    #       .format(top1=metric_logger.acc1, f1=metric_logger.f1, prec=metric_logger.prec, rec=metric_logger.rec, losses=metric_logger.loss))
    # else:
